...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2024-08-06 12:16:22" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2024-08-06 12:16:54" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2024-08-06 12:16:54" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2024-08-06 12:16:57" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2024-08-06 12:16:57" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2024-08-06 12:16:57" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2024-08-06 12:16:57" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "emacs-everywhere" ("2024-08-06 12:16:22" ("emacs") (:type git :flavor melpa :host github :repo "tecosaur/emacs-everywhere" :package "emacs-everywhere" :local-repo "emacs-everywhere")) "evil" ("2024-08-06 12:17:04" ("emacs" "goto-chg" "cl-lib") (:type git :flavor melpa :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil" :package "evil" :local-repo "evil")) "goto-chg" ("2024-08-06 12:16:57" ("emacs") (:type git :flavor melpa :host github :repo "emacs-evil/goto-chg" :package "goto-chg" :local-repo "goto-chg")) "monokai-theme" ("2024-08-06 12:17:06" nil (:type git :flavor melpa :host github :repo "oneKelvinSmith/monokai-emacs" :package "monokai-theme" :local-repo "monokai-emacs"))))
...
("lsp-mode" "ibuffer" "monokai-theme" "cl-lib" "goto-chg" "evil" "emacs-everywhere" "emacs" "straight" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa")
